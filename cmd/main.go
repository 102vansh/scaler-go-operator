...
import (
	...
	"github.com/scaler/internal/controller"
...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":8087", "The address the metric endpoint binds to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "168d3f7e.my.domain",
